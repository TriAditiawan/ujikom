<?php
    ...
    $modul = $_GET['module'];
    if ($modul=='home'){
    	echo "<h2 style=' padding-top: 50px; font-size:28px;'>Selamat Datang </h2>";
    	echo "<p style='font-size:20px;'> Hai, <b>".$_SESSION['username']."</b> . <b>Selamat datang, Di Sistem Informasi Pembayaran Listrik</b><p>";
